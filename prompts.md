...
1. **Curriculum** — A structured JSON containing the complete 31-day AI Cohort curriculum, including:
   - Modules
   - Daily topics
   - Learning objectives
   - Tools used throughout the program

2. **Candidate Profiles** — A collection of candidate profiles describing each participant's progress through the cohort, including:
   - Completed missions
   - Attempts
   - Skipped topics
   - Learning signals

3. **Technical Specification** — A separate document defining:
...
Add voice enabler and should premium like dashboard
...
Eyecatching dashboard

---

## 5th Prompt

Nav bar should change and stylish and under interview section option of choose a candidate should be eyecatching

---

## 6th Prompt

Must be a login page and according to their name, welcoming page should appear and then start an interview

---

## 7th Prompt

When we're giving interview there should be present my name rather than "you"
